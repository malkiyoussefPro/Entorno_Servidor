  ...
  <tbody>
    ...
    ?>
      <tr>
        ...
        <td>      
          <a href="/student042/dwes/Usuarios/formulario_usuario_update.php?id_usuario=<?php echo $usuario['id_usuario']; ?>" name="actualizar" id="btn_formulario" class="btn btn-warning btn-sm m-1"> Actualizar</a>
        </td>
        <td>      
