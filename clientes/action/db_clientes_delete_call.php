...
?>
  ...
  <h2 style="color: #000000; text-align: center; margin-top: 25px;">Formulario suprimir cliente</h2>
  <form class="myFormCliente" action="" method="POST">
    <div class="container mt-2 ms-2" >
      <div class="form-row" >
        <div class="form-group col-md-6 ">
          <label for="inputCliente" style ="color: #040212">Id cliente</label>
          <input type="number" class="form-control" name="id_cliente" id="inputCliente" placeholder="Id cliente">
        </div>
      </div>
