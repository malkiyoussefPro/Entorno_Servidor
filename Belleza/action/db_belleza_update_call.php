...
?>
  ...
  <h2 style="color: #000000; text-align: center; margin-top: 25px;">Formulario actualizar Belleza</h2>
  <form class="myFormCliente" action="" method="POST">
    <div class="container mt-2 ms-2" >
      <div class="form-row" >
      <div class="form-group col-md-6 ">
          <label for="inputBelleza" style ="color: #040212">Id belleza</label>
          <input type="number" name="actualizar" class="form-control" name="id_belleza" placeholder="Id belleza">
        </div>
      </div>
