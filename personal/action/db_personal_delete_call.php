...
?>
  ...
  <h2 style="color: #000000; text-align: center; margin-top: 25px;">Formulario suprimir personal</h2>
  <form class="myFormpersonal" action="" method="POST">
    <div class="container mt-2 ms-2" >
      <div class="form-row" >
        <div class="form-group col-md-6 ">
          <label for="inputpersonal" style ="color: #040212">Id personal</label>
          <input type="number" class="form-control" name="id_personal" id="inputpersonal" placeholder="Id personal">
        </div>
      </div>
