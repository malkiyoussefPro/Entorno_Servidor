...
?>
  ...
  <div class="container mt-5">
    <h2 style="color: #000000; text-align: center; margin-top: 25px;">Formulario insertar personal</h2>
    <form class="myFormpersonal" action="" method="POST">
      <div class="container">
        
        <div class="form-group">
          <label for="inputpersonal" style="color: #040212">Nombre personal</label>
        ...
        <div style="display: flex; justify-content: center;">
          <button type="submit" class="btn btn-primary mt-2" style="background-color: #000000; border-color: #feffe2; color: #505050; font-weight: bold;">Insertar</button>
        </div>
      </div>
    </form>
